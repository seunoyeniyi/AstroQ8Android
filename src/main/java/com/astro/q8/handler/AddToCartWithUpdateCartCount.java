...
public class AddToCartWithUpdateCartCount {
    Context context;
    Activity activity;
    ...
    public AddToCartWithUpdateCartCount(Context context, String productID, String quantity, Boolean replaceQuantity, TextView cartCounter) throws JSONException {
